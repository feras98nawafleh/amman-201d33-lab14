...
function populateForm() {
  ...
  for (let i in Product.allProducts) {
    ...
    opt.value = Product.allProducts[i].filePath;
...
function updateCounter() {
  ...
  counter.innerText = product.allProducts.length;
}
...
function updateCartPreview() {
  ...
  contents = document.createElement('cartContents');
  contents.appendChild(item);
  contents.appendChild(quanity);
}
